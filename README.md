# TALLER 04-Diego Vargas
**CI/CD: Automatización y GitHub Actions**

## Tareas Realizadas
* **Corrección del Workflow:** Se corrigió el archivo `workflow.yml` para configurar correctamente el entorno de ejecución, permitiendo que el pipeline instale dependencias y ejecute pytest.
